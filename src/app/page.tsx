  ...
  return (
    <div className="py-10 flex h-screen bg-no-repeat bg-cover bg-center absolute inset-0  opacity-95 bg-bannerImg ">
      <div className=" flex flex-col items-center justify-center  w-full">
        <h1 className="text-white text-5xl sm:text-8xl justify-center    items-center  flex tracking-wider text-foreground font-cormorant animate-fade animate-once animate-ease-linear animate-normal duration-700">
          CLIMATHER
        </h1>
